...
if(isset($_POST['Submit'])) {    
    ...
    // checking empty fields
        ...
        //$result = mysqli_query($mysqli, "INSERT INTO customer(FName,LName,UName,NIC,Mobile,Address,AccountType,pin,CardNumber,ExpDate,CardType,amount) VALUES('$FName','$LName','$UName','$NIC','$Mobile','$Address','$AccountType','$pin','$CardNumber','$ExpDate','$CardType','$amount')");
        
		$payquery = "INSERT INTO `customer`(FName,LName,UName,NIC,Mobile,Address,AccountType,pin,CardNumber,ExpDate,CardType,amount) VALUES('$FName','$LName','$UName','$NIC','$Mobile','$Address','$AccountType','$pin','$CardNumber','$ExpDate','$CardType','$amount')";
...
include_once('dbconfig.php');
		...
		$payquery = "SELECT * FROM `customer` ORDER BY Mobile DESC";
		$payresult = mysqli_query($conn, $payquery);
?>
...
<head>
  ...
  <title>Besafe - Customer Register</title>
...
<!-- **********************************************************************************************************************************************************
    ...
    <section id="main-content">
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Customer Register</h3>
								...
								<table >
									...
									<tr>
										<td  >User Name</td>
													...
													<td><input type="text" 
												   name="UName"  id="UName" autocomplete="off" pattern="[a-z0-9._%+-]{1,40}[@]{1}[a-z]{1,10}[.]{1}[a-z]{3}"
									...
									<tr>
										<td  >Pin Number</td>
										<td><input type="text" 
												   name="pin" id="pin" autocomplete="off" pattern="[0-9]{4}" 
									...
									<tr>
										<td  >Card Number</td>
											<td><input type="text" name="CardNumber" id="CardNumber" autocomplete="off" pattern='^(?:4[0-9]{12}(?:[0-9]{3})?|[25][1-7][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$' 
									...
									<tr>
										<td  >Amount</td>
										<td><input type="text" name="amount"   id="amount"autocomplete="off" pattern="[0-9]+" 
									...
									<tr>
										<td > </td>
										<td ><input type="submit" value="Add Customer"  name="Submit" > </td>
									</tr>
									</tbody>
								</table>
								</form>
