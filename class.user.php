...
public function update($bankname,$bankcode,$email,$upass,$id)
	...
	{						
		...
		$mail->SMTPAuth   = true;                  
		$mail->SMTPSecure = "ssl";                 
		$mail->Host       = "mail.geoauth.info";      
		$mail->Port       = 465;             
		$mail->AddAddress($email);
		$mail->Username="info@geoauth.info";  
		$mail->Password="6v6=Dy)W-8C)";            
		$mail->SetFrom('info@geoauth.info','GeoAuth');
		$mail->AddReplyTo("info@geoauth.info","GeoAuth");
